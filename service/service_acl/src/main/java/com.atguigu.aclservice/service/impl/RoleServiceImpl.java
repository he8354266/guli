 ...
 * @description zkjy
 * @updateUser
 * @createDate 2021/6/28 10:14
 * @updateDate 2021/6/28 10:14
 **/
@Service
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public Map<String, Object> findRoleByUserId(String userId) {
        ...
        List<String> existRoleList = existUserRoleList.stream().map(item -> item.getRoleId()).collect(Collectors.toList());
