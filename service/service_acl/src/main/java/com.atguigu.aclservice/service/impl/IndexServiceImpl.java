 ...
 * @description zkjy
 * @updateUser
 * @createDate 2021/6/30 16:21
 * @updateDate 2021/6/30 16:21
 **/
@Service
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        List<String> roleNameList = roleList.stream().filter(item -> item != null).map(item -> item.getRoleName()).collect(Collectors.toList());
