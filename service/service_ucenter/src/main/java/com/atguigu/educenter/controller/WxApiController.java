 ...
 * @description zkjy
 * @updateUser
 * @createDate 2021/8/19 9:39
 * @updateDate 2021/8/19 9:39
 **/
@CrossOrigin
...
public class WxApiController {
    @Autowired
    private UcenterMemberService memberService = null;
    ...
    public String callback(String code, String state) {
        try {
            ...
            System.out.println(mapAccessToken);
            ...
            if (member == null) {//member为空，表示没有相同微信数据，进行添加
                ...
                String baseUserInfoUrl = "https://api.weixin.qq.com/sns/userinfo" +
                        "?access_token=%s" +
                        "&openid=%s";
                String userInfoUrl = String.format(baseAccessTokenUrl, access_token, openid);
                //发送请求
                String userInfo = HttpClientUtils.get(userInfoUrl);
                //获取返回userinfo字符串扫描人信息
                HashMap userInfoMap = gson.fromJson(userInfo, HashMap.class);
                String nickname = String.valueOf(userInfoMap.get("nickname"));//昵称
                String headimgurl = String.valueOf(userInfoMap.get("headimgurl"));//头像
